...
namespace ZoroDex.SimpleCard.Patterns
{
    ...
    //TODO: Interfaces, because mid level interfaces cause a duplicate register as [KEy, Listener].
    ...
    public class Observer<T> : SingletonMB<Observer<T>>
    {
        ...
        /// <summary>
        ///     This is the Subject-Listener register. It supports both, MonoBehaviours and
        ///     Pure C# classes that 
        /// </summary>
        private readonly Dictionary<Type, List<IListener>> register
            = new Dictionary<Type, List<IListener>>();
        ...
        #region Operations
        /// <summary>
        ///     Register a listener as well as its implemented interface subjects.
        /// </summary>
