...
namespace ZoroDex.SimpleCard.Patterns
{
    public abstract class BaseStateMachine
    {
        ...
        {
            if (state == null)
                throw new ArgumentNullException("Null is not a value state");
        ...
        /// <summary>
        ///     Checks if  an StateType is the current state.
        /// </summary>
        /// <param name="state"></param>
        /// <returns></returns>
        /// <exception cref="ArgumentNullException"></exception>
        ...
        public void PopState(bool isSilent = false)
        {
            ...
            var state = stack.Pop();
            Logger.Instance.Log<BaseStateMachine>(Handler.Name + ", Pop state: ", "purple",
                state.GetType());
            state.OnExitState();
