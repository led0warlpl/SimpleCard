...
namespace ZoroDex.SimpleCard.Patterns
{
    ...
    where T1 : class
    {
        ...
        [Tooltip("All pooled models have to be inside this array befoe the initialization")] [SerializeField]
        ...
        void OnEnable()
        {
            //avoiding executing when the game isn't playing
        ...
        ///     stored back for future usage using the prefab model as Key
        /// </summary>
        /// <param name="prefabModel"></param>
        ...
        {
            // If you need to execute some code right BEFOR the object is pooled, you can do it here.
        ...
        protected virtual void OnRelease(GameObject prefabModel)
        {
            ...
            //Clean references ore reset variables are very common cases.
        }
