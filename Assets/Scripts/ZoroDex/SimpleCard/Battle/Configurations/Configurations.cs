...
namespace ZoroDex.SimpleCard
{
    ...
    public class Configurations : ScriptableObject
    {
        ...
        //ai
        public AiArchetype TopAiArchetype => Ai.TopPlayer.Archetyp;
        public AiArchetype BottomAiArchetype => Ai.BottomPlayer.Archetyp;
        ...
        public int MaxMan => Amount.HealthPlayers.maxMana;
        ...
        public class GameStartEvents
        {
            ...
            [Range(0.01f, 0.5f)] [Tooltip("Time between Load and PregameEvent")]
